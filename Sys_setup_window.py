...
def sys_setup():
    ...
    class System_setup(tk.Canvas):
        ...
        def __init__(self, master = None):
            ...
            self.Ok()
            self.Apply()
            self.create_text((180,68),activefill="red",text="Gp(s) num",fill="black")
            self.create_text((180,98),activefill="red",text="Gp(s) den",fill="black")
            self.create_text((280,138),activefill="red",text="Simulation Parameters",font =tkFont.Font(weight = 'bold') )
            self.create_text((40,168),activefill="red",text="Sim time(s)",fill="black")
            self.create_text((40,198),activefill="red",text="Time inc.(s)",fill="black")
            self.create_text((40,228),activefill="red",text="Dead time(s)",fill="black")
            self.create_text((280,30),activefill="red",text="Process Tranfser function",font =tkFont.Font(weight = 'bold'))
            self.create_text((350,168),activefill="red",text="Set Point",fill="black")
            self.create_text((350,198),activefill="red",text="Step time(s)",fill="black")
            self.create_text((350,228),activefill="red",text="Ramp time(s)",fill="black")
            self.create_text((350,275),activefill="red",text="SP input type",fill="black")
        def TFnum(self):
        ...
        def Ok(self):
            self.okb= tk.Button(self, width = 10,text ='Ok', command = self.Get_entries)
            self.okb.place(x= 390, y = 350)
            
        def Apply(self):
            self.appyb = tk.Button(self, width = 10,text ='Apply', command = self.Get_entries2)
