...
class System_setup(tk.Canvas):
    ...
    def __init__(self, master = None):
        ...
        self.create_text((
            50, 168), activefill="red", text="Simulation time(s)", fill="black")
        self.create_text((50, 198), activefill="red",
                         text="Time increment(s)", fill="black")
...
#    appyb.place(x=290, y=3class System_setup(tk.Toplevel):
